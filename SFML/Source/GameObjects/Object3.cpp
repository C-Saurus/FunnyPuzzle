...
void Object3::Init()
{
	...
	autoPaddle1.setFillColor(sf::Color(0, 245, 255));
	...
	autoPaddle2.setFillColor(sf::Color(0, 245, 255));
	...
	autoPaddle3.setFillColor(sf::Color(0, 245, 255));

	//target
	target1.setTexture(DATA->getTexture("item/target3"));
	...
	target2.setTexture(DATA->getTexture("item/target3"));
	...
	target3.setTexture(DATA->getTexture("item/target3"));
...
void Object3::Update(float deltaTime)
{
	//paddle moving
...
void Object3::Render(sf::RenderWindow* window)
{
